...
import FromInput from '../partials/FormInput';
import EmptyCompany from '../partials/EmptyCompany';
import States from '../partials/States';

const ComanpyForm = ({ c, button }) => {
    const [comapny, setCompany] = useState(c);

    const handleAddressChange = (e) => {
        e.preventDefault();
        const { anem, value } = e.target;
        setCompany({...comapny, ['companyAddress']: {...comapny.companyAddress, [name]: value}});
    };
